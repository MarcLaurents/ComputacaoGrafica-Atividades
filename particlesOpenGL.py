...
class ParticleEmitter:
  def __init__(self, position, velocity, color, rate, size):
    self.position = np.array(position)
...
def main():
  ...
  new_emitter = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter)
  new_emitter1 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter1)
  new_emitter2 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter2)
  new_emitter3 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter3)
  new_emitter4 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter4)
  new_emitter5 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  particles.add_emitter(new_emitter5)
  new_emitter6 = ParticleEmitter([0.0, 0.5], [-0.5, 1.0], [1.0, 1.0, 0.0, 1.0], 50.0, 1500.0)
  ...
  while not glfw.window_should_close(window):
    ...
    time = glfw.get_time()
    particles.update(dt)
    positions = np.array([particle.position for particle in particles.particles], dtype=np.float32)
